...
do
    ...
    if [ ! -d "$OUTPUT_DIR" ]; then
        ...
        ./configure --disable-programs --disable-shared --enable-static --enable-pic --enable-small --disable-librtmp --disable-openssl ${DEBUG_CONFIG_ARGS} \
        --disable-decoders --enable-decoder=aac --enable-decoder=h264 \
        --disable-encoders --enable-encoder=aac \
        --disable-demuxers --enable-demuxer=aac --enable-demuxer=mov --enable-demuxer=mpegts --enable-demuxer=h264 --enable-demuxer=caf \
        --disable-muxers --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=hls --enable-muxer=h264 --enable-muxer=mpegts --enable-muxer=adts --enable-muxer=caf \
